...
export default function ProxyAPI() {
  ...
  return (
    <>
      <SEOHead title="Proxy API — Programmatic Proxy Management" description="REST API for managing proxies programmatically." canonical="https://upgraderpx.com/proxy-api" />
      <SchemaProduct name="UpgradedProxy API" description="REST API for programmatic proxy management" price="0" />
      <SchemaFAQ items={FAQ_ITEMS} />

      <section className="container py-16">
        <h1 className="text-4xl font-bold tracking-tight">{t("page.apiTitle")}</h1>
        <p className="mt-4 max-w-2xl text-lg text-muted-foreground">{t("page.apiSub")}</p>
      </section>
